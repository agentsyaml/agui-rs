...
mod tests {
    ...
    async fn builds_assistant_message_from_text_events() {
        let items = collect(vec![
            ...
            ag_ui_core::factory::text_message_end("m1"),
        ])
        .await;
    ...
    mod tool_call_apply {
        use super::*;
        use ag_ui_core::{ReasoningEncryptedValueEvent, ToolCallResultEvent};
        ...
        async fn merges_tool_call_args_across_lifecycle() {
            let state = apply_all(vec![
                ...
                ag_ui_core::factory::tool_call_args("tc1", "{\"q\":\"ru"),
                ag_ui_core::factory::tool_call_args("tc1", "st\"}"),
                ag_ui_core::factory::tool_call_end("tc1"),
            ]);
    ...
    mod state_patches {
        use super::*;
        use ag_ui_core::{MessagesSnapshotEvent, StateSnapshotEvent};
